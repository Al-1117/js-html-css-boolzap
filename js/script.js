$(document).ready(
  ...
  // ELIMINAZIONE DEI MESSAGGI GENERATI DINAMICAMENTE E NON
  ...
  $(document).on('click', '.single_chat',
    function (){
      ...
      // Aggiungo la classe della chat selezionata solo dalla
  ...
  function messageSent(){
    ...
    // Controllo che la lunghezza del valore nell'input non sia pari 0
     // prima di procedere con la funzione di invio del messaggio
    if (newMessageSent.length != 0) {
